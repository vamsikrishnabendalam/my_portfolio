class AppAssets {
  ...
  static String accenture = 'assets/images/accenture.png';
  static String capgemini = 'assets/images/capgemini.png';
  static String flutter = 'assets/images/flutter.jpg';
  static String abinitio = 'assets/images/abinitio.png';
  static String machine = 'assets/images/machine.png';
  static String redcaps = 'assets/images/redcaps.png';
  static String saveetha = 'assets/images/saveetha.png';
}
